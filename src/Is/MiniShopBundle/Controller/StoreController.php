...
use Is\MiniShopBundle\Entity\ProductTransfer;
...
class StoreController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        if ($request->isMethod('POST')) {
            ...
            return $this->redirect($this->get('router')->generate('is_minishop_index_index'));
        }
    ...
    {
        return $this->getDoctrine()->getManager()->getRepository('IsMiniShopBundle:Store');
    }

    protected function getProductRepository()
    {
        return $this->getDoctrine()->getManager()->getRepository('IsMiniShopBundle:Product');
    }
}
